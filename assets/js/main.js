    ...
    var imJs = {
        ...
        testimonialActivation: function () {
            $('.testimonial-activation').slick({
                ...
                // <i data-feather="arrow-right" class="feather-arrow-right"></i>
                prevArrow: '<button class="slide-arrow prev-arrow"><img src="/assets/images/arrow-left.svg" class="feather-arrow-left"></button>',
                nextArrow: '<button class="slide-arrow next-arrow"><img src="/assets/images/arrow-right.svg" class="feather-arrow-right"></button>'
            });
            ...
            $('.testimonial-item-one').slick({
                ...
                adaptiveHeight: true,
                cssEase: 'linear',
                prevArrow: '<button class="slide-arrow prev-arrow"><i data-feather="arrow-left" class="feather-chevron-left"></i></button>',
                nextArrow: '<button class="slide-arrow next-arrow"><i data-feather="arrow-right" class="feather-chevron-right"></i></button>',
                responsive: [
                {
                    breakpoint: 1200,
                    settings: {
